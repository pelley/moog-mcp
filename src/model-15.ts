...
import type { ControlKind, ControlSpec } from "./model-d.js";

export type Model15Section =
  | "oscillators" // 921A driver + 921B x3
  | "mixer" // audio levels into the filter
  | "filters" // 904A low-pass, 904B high-pass, 904C coupler
  | "envelopes" // 911 envelope generators x2
  | "amplifiers" // 902 VCAs x2
  | "modulation" // noise, external input
  | "sequencer" // 960 sequential controller
  | "performance"; // keyboard, wheels, glide, master out

// Re-export ControlSpec so callers can import everything from this file.
export type { ControlKind, ControlSpec };
...
export const CONTROL_SURFACE: ControlSpec[] = [
  ...
  // 921A Oscillator Driver — sets the master pitch that all 921Bs track.
  {
    ...
    kind: "continuous",
    description:
      "921A Oscillator Driver master frequency (coarse tune). All three 921B oscillators track this as their base pitch.",
  },
  {
    id: "driver_range",
    ...
    description:
      "921A octave range. LO = sub-audio (use as master LFO clock). 32'/16'/8'/4'/2' = descending octaves.",
  },
  ...
  // 921B Oscillator 1
  {
    ...
    positions: ["LO", "32'", "16'", "8'", "4'", "2'"],
    description:
      "921B #1 octave/range switch. LO = sub-audio. 8' is the standard concert-pitch octave.",
  },
  {
    id: "osc1_frequency",
    ...
    kind: "continuous",
    description:
      "921B #1 fine-tune offset relative to the 921A driver. Center = unison with driver; sweep ±7 semitones.",
  },
  {
    id: "osc1_waveform",
    ...
    description:
      "921B #1 waveform output. Triangle = soft/flute-like; sawtooth = bright/buzzy; square = hollow/reedy.",
  },
  {
    id: "osc1_pulse_width",
    ...
    kind: "continuous",
    description:
      "921B #1 pulse width. Only audible when waveform is set to square. 0.5 = true square; lower/higher = narrow pulse (nasal, thin).",
  },
  ...
  },
  {
    ...
    kind: "continuous",
    description:
      "921B #2 fine-tune offset. Slight detune from Osc 1 creates classic Moog chorus/beating.",
  },
  {
    id: "osc2_waveform",
  ...
  // 921B Oscillator 3
  {
    ...
    positions: ["LO", "32'", "16'", "8'", "4'", "2'"],
    description:
      "921B #3 octave/range switch. Set to LO when repurposing Osc 3 as a modulation source.",
  },
  {
    id: "osc3_frequency",
  ...
  },
  {
    ...
    kind: "switch2",
    description:
      "Noise generator spectrum. Off = white (flat, hissier); on = pink (−3 dB/octave, warmer/rumbly).",
  },
  {
    id: "ext_input_volume",
    ...
    kind: "continuous",
    description:
      "Level of the external audio input into the mixer. Route back to create feedback through the 904A for self-oscillating textures.",
  },
  ...
  // 904A Low Pass Filter
  {
    ...
    kind: "continuous",
    description:
      "904A Voltage Controlled Low Pass Filter cutoff frequency. The heart of the Moog sound. Low = dark/muffled; high = bright/open.",
  },
  {
    id: "lpf_emphasis",
    ...
    kind: "continuous",
    description:
      "904A filter resonance. Emphasizes frequencies near the cutoff. High values produce a nasal, whistling quality. The 904A self-oscillates near maximum, producing a sine wave at the cutoff frequency.",
  },
  {
    id: "lpf_env_amount",
    ...
    kind: "continuous",
    description:
      "How much Envelope 1 modulates the 904A cutoff. 0 = static filter; high = dramatic sweep on each triggered note.",
  },
  {
    ...
    description:
      "How much keyboard pitch shifts the 904A cutoff. 'full' = filter tracks pitch 1:1, keeping timbre consistent across the keyboard. 'off' = filter is independent of pitch.",
  },
  ...
  // 904B High Pass Filter
  {
    ...
    kind: "continuous",
    description:
      "904B Voltage Controlled High Pass Filter cutoff frequency. Removes low frequencies. Useful for thinning out bass-heavy patches or creating telephone/radio effects.",
  },
  ...
  // 904C Filter Coupler
  {
    ...
    kind: "continuous",
    description:
      "904C Filter Coupler balance between the 904A low-pass and 904B high-pass outputs. Center = band-pass response; extremes = pure LP or pure HP.",
  },
  ...
  // 911 Envelope Generator 1 — typically patched to the filter (904A CV input)
  {
    ...
    kind: "continuous",
    description:
      "911 #1 attack time. In the standard patch this shapes the filter sweep. 0 = instant; max = very slow rise. Short attack = percussive; long = swelling pad.",
  },
  {
    id: "env1_decay",
    ...
    kind: "continuous",
    description:
      "911 #1 decay time. Time to fall from peak to sustain level after the attack completes.",
  },
  {
    id: "env1_sustain",
    ...
    kind: "continuous",
    description:
      "911 #1 sustain level. The contour height held while a gate is open (key held). 0 = fully decays; max = no decay.",
  },
  {
    id: "env1_release",
    ...
    kind: "continuous",
    description:
      "911 #1 release time. How long the filter sweep tail lasts after the gate closes (key released). Long release = lingering filter sweep.",
  },
  ...
  // 911 Envelope Generator 2 — typically patched to the VCA (902 CV input)
  {
    ...
    kind: "continuous",
    description:
      "911 #2 attack time. In the standard patch this shapes the amplitude (loudness) envelope. 0 = instant pluck; max = slow swell.",
  },
  {
    id: "env2_decay",
  ...
  },
  {
    ...
    kind: "continuous",
    description:
      "911 #2 release time. How long the note fades after key release. Long release = reverberant, trail-off feel.",
  },
  ...
  // 902 VCA #1 — typically the main output VCA, controlled by Envelope 2
  {
    ...
    kind: "continuous",
    description:
      "902 #1 initial (base) gain level before CV modulation. At 0 with envelope patched, notes are silent between triggers. Raise for a drone that the envelope shapes on top of.",
  },
  ...
  // 902 VCA #2 — available for parallel signal paths or layered modulation
  {
    ...
    kind: "continuous",
    description:
      "902 #2 initial gain. Use for a secondary signal path (e.g. a dry oscillator blend) or as a CV-controlled crossfader in more complex patches.",
  },
  ...
  // 960 Sequential Controller — 8-step analog sequencer
  {
    ...
    kind: "continuous",
    description:
      "960 Sequential Controller clock rate. Controls how fast the sequencer advances through its steps. Low = slow arpeggiation; high = trilling/rhythmic texture.",
  },
  {
    id: "seq_stages",
    ...
    description:
      "Number of active steps in the 960 sequence (1–8). The sequencer loops back after this many stages. Shorter loops = ostinato; 8 = full phrase.",
  },
  ...
  // ============ PERFORMANCE ============
  {
    ...
    kind: "continuous",
    description:
      "Portamento time between notes. 0 = instant pitch change; max = very slow glide. Combine with glide_on.",
  },
  {
    id: "glide_on",
  ...
  },
  {
    ...
    kind: "modWheel",
    description:
      "Modulation wheel — sends MIDI CC1. In the Model 15 app this is typically routed to LFO depth or filter cutoff offset via the patch matrix.",
  },
  {
    id: "pitch_wheel",
    ...
    kind: "pitchWheel",
    description:
      "Pitch bend wheel — sends 14-bit MIDI Pitch Bend. ±2 semitones by default (configurable in the app's MIDI settings).",
  },
];
...
export function findControl(id: string): ControlSpec {
  ...
  if (!c) {
    throw new Error(
      `Unknown Model 15 control: "${id}". Available: ${CONTROL_SURFACE.map((c) => c.id).join(", ")}`,
    );
  }
  return c;
}
